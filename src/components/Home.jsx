        ...
        <Layout>
            <div>
                ...
                <div className="md:p-16 p-8">
                    ...
                    <p className="text-center mx-auto text-gray-600 md:w-7/12 mt-2 mb-16">Discover the newest arrivals at ShopOnline - from trendy fashion and cutting-edge electronics to unique home goods. Shop now and stay ahead with our latest and most sought-after items!</p>
